...
**Current checkpoint:** `debrief-qwen3-8b-asrs-v02`  
...
| `debrief-qwen3-8b-asrs-v02` | label map 4 | Same base, hyperparameters and prompts. Gold extractors widened so lessons, near misses and recovery carry signal; event-class grounding added. Held-out evaluation pending. |

No adapter is accepted for use yet. The PRD decision rule after v0.1 was "fix data", not "stop": grounding did not get worse than the base.
